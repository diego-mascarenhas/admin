					...
					<div class="iconos pull-left margin-l-20">
						...
						<ul class="bc-grey-5">
							...
							<li class="margin-l-10">
								<a href="https://www.instagram.com/revision_alpha/?hl=es" title="Instagram"
									target="_blank">
				...
				<div id="sliderHeader" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active" style="background-image:url('/assets/img/slider/cloud-server.jpg');">
							<div class="container">
								<h3>Cloud Servers</h3>
								<p>Servidores virtuales <span class="tw-semibold">CLOUD</span> a la medida de tu
									proyecto.
									<br>Servidores Linux, Windows, Escritorio Remoto y acceso VPN.
								</p>
						...
						<div class="item" style="background-image:url('/assets/img/slider/marketing-digital.jpg');">
							<div class="container">
								...
								<p>Comunicarte con tus clientes <span class="tw-semibold">nunca fue tan
										fácil.</span><br>
									Herramientas de email Marketing, Landing Page Builder y <span
										class="tw-semibold">WhatsApp.</span></p>
						...
						<div class="item" style="background-image:url('/assets/img/slider/managed-server.jpg');">
							<div class="container">
								...
								<p>Administramos y monitoreamos tu servidor por ti.<br>
									Rendimiento y flexibilidad con un <span class="tw-semibold">servidor
										administrado.</span></p>
			...
			<div class="container">
				<div class="col-lg-4 col-sm-4 col-xs-12 footer-info pull-left">
					...
					<ul>
						...
						<li><span class="tw-semibold"></span> <a
								href="mailto:info@revisionalpha.es?subject=Contacto desde revision alpha">info@revisionalpha.es</a>
						</li>
