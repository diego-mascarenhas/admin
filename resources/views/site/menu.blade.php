            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <nav class="navbar navbar-inverse" role="navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" data-hover="dropdown"
                        ...
                        <ul class="navbar-nav">
                            <li class="hidden-xs hidden-sm hidden-md @if (Route::currentRouteName() === 'home') active @endif">
                                <a href="/">Inicio</a>
                            </li>
                            <li class="dropdown @if (Route::currentRouteName() === 'hosting' ||
                                    Route::currentRouteName() === 'cloud' ||
                                    Route::currentRouteName() === 'servidores-dedicados') active @endif">
                            ...
                            <li class="@if (Route::currentRouteName() === 'emailer') active @endif"><a href="/emailer/">Emailer</a>
                            </li>
                            <li class="dropdown @if (Route::currentRouteName() === 'auditoria-consultoria-desarrollo' ||
                                    Route::currentRouteName() === 'simple-click-to-call') active @endif">
                                ...
                                <ul class="dropdown-menu navbar-right" role="menu">
                                    ...
                                    <li>
                                        <a href="/wordpress/">
                                            <span class="margin-r-5">></span> WordPress<br>
                                            <span class="sub">Optimización y seguridad</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/emailer/">
                            ...
                            @else
                                <li class="hidden-xs pull-right">
                                    <a href="{{ route('dashboard') }}" style="float:left;"><i
                                            class="fa fa-sign-in margin-r-5" aria-hidden="true"></i> Mi Cuenta</a>
                                </li>
                            @endguest
                        </ul>
                    </div>
